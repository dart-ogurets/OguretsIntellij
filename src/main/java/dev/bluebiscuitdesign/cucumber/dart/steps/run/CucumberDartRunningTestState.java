...
public class CucumberDartRunningTestState extends CommandLineState {
    ...
    @NotNull
    protected final CucumberDartRunnerParameters myRunnerParameters;
...
//			consoleView.addMessageFilter(new UrlFilter());
    ...
    protected ProcessHandler startProcess() throws ExecutionException {
        ...
        try {
            ...
            final String message = ("<a href='" + DartProblemsView.OPEN_DART_ANALYSIS_LINK + "'>Analysis issues</a> may affect " + "the execution of '" + dartRunConfiguration.getName() + "'.");
    ...
    private void setupParameters(@NotNull final DartSdk sdk, @NotNull final GeneralCommandLine commandLine) throws ExecutionException {
